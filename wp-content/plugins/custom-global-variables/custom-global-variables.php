	...
	function admin_page() {
		...
		<div class="wrap">
			...
			<div class="card">
				...
				<p>Informações não preenchidas serão ocultadas do site.</p>
					...
					<table id="custom-global-variables-table-definitions">
						...
						<tbody>
							...
							if ( !empty( $vars ) ):
								...
								$infoArr = array (
									'endereco-1' => "Endereço 1",
									'endereco-2' => "Endereço 2",
									'telefone' => "Telefone",
									'fax' => "Fax",
									'email' => "Email",
									'linkedin' => "LinkedIn",
							...
							?>
								...
								<?php foreach ( $vars as $key => $val ):  ?>
									...
									<tr>
										...
										<td><div style="padding:0.75em"><?= $infoArr[$key] ?></div><input autocomplete="off" name="vars[<?php echo $i ?>][name]" placeholder="name" type="hidden" value="<?php echo $key ?>"></td>
										...
										<td class="options" style="display: none;">
